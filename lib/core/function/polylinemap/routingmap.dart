...
import 'package:delivery/core/function/polylinemap/polyline_algorithm.dart';
...
class RoutingMap {
  ...
  routing(List<LatLng> routeCoordinates, LatLng position, LatLng latLng,
      {List<LatLng>? multiPositions = const []}) async {
    print("==================================================================");
    List<LngLat> waypoints = [
      ...
      ...List.generate(
        ...
        (index) => LngLat(
            lng: multiPositions[index].longitude,
            lat: multiPositions[index].latitude),
      ),
